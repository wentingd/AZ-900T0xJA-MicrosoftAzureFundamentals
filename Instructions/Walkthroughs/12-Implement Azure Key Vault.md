...
2. 「**すべてのサービス**」 ブレードで、「**キー コンテナー**」 を検索して選択し、**「+ 追加」、「+ 作成」、「+ 新規」** のいずれかを選択します。
...
4. 「**確認および作成**」 をクリックし、検証後、「**作成**」 をクリックします。 
...
5. 現在のバージョンをクリックし、「**シークレット ID**」 をメモします。これは、アプリケーションで使用できる URL 値です。一元管理され、安全に保存されたパスワードを提供します。
